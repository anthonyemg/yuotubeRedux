      ...
      <div className='TopMenuMobile'>
        <div className='TopMenuMobile-top' style={{backgroundColor: this.props.selectedVideo ? 'rgb(51,51,51)' : 'rgb(253,0,0)'}}>
          <div>
            ...
            {!this.state.showSearchBar && !this.state.searchQuery &&
              <span>Home</span>
            }
            {!this.state.showSearchBar &&
              <span>{this.state.searchQuery}</span>
            }
          </div>
          ...
          <div>
            {!this.state.showSearchBar ?
              <div>
                <i className='fa fa-search fa-lg' style={{marginLeft:12, marginRight:12}} onClick={this.handleShowSearchBar} />
        ...
        {this.state.showSearchBar &&
          <div className='lightBox' onClick={this.handleHideSearchBar}></div>
        }
      </div>
